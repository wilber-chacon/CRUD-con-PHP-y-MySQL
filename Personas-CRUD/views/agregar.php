...
<body>
  ...
  <div class="container shadow mb-5 pb-4">
    ...
    <div class="mb-5 mt-5 p-5 titulo text-white text-center">
      <h1 class="m-0 text-center text-uppercase">Agregar registro</h1>
    </div>

    <section class="content">
      <div class=" container col-10 card mb-4">
        <div class="card-body">
          <form class="row g-3 mb-2" id="form-register">
            ...
            <div class="col-md-6">
              ...
              <input class="form-control" name="primer-apellido" type="text" required>
              <br>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-4 mt-4">
              ...
              <input class="form-control" name="telefono" type="text" placeholder="(000) 00000000">
            </div>
            <div class="col-md-4 mt-4">
